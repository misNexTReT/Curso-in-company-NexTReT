...
```javascript
    var tanque = function(capacidad, dimensiones, color, nivelAgua){
        this.capacidad = capacidad;
        this.dimensiones = dimensiones;
        this.color = color;
        this.nivelAgua = nivelAgua;
    };
    var cama = function(capacidad, dimensiones, color, nivelAgua, sustrato){
        this.capacidad = capacidad;
        this.dimensiones = dimensiones;
        this.color = color;
        this.nivelAgua = nivelAgua;
...
```javascript
    var tanque = function(capacidad, dimensiones, color, nivelAgua){
        ...
        this.avisoSobrante = function() {
            if(this.nivelAgua > this.capacidad){
                alert("Cuidado!, has sobrepasado el limite de la capacidad de agua del tanque.");
                //Vaciamos el sobrante dejandolo al limite
